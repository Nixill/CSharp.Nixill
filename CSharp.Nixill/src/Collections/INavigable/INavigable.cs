...
/// </summary>
public interface INavigableSet<T> : ISet<T>, IReadOnlyNavigableSet<T>
{
...
///   <c>HigherKey</c>.
/// </summary>
public interface INavigableDictionary<K, V> : IReadOnlyNavigableDictionary<K, V>, IDictionary<K, V>
{
  new public bool TryGetValue(K key, out V value);
  new public bool ContainsKey(K key);

  new public IEnumerable<K> Keys { get; }
  new public IEnumerable<V> Values { get; }
  new public V this[K key] { get; set; }
